    ...
    <div className="w3-row-padding w3-section">
      <div className="w3-col l3 m6">
        <div className="tooltip-dev" data-tooltip="Clone de Flappy Bird - (React-Native). &#xa; &#xa; Clône du celebre jeu Flappy Bird, jeu conçu en React-Native avec comme dépendances : matter.js, react-native-paper et react-native-engine."
          ...
          <img className="img-cursor" src="/assets/images/developpeur/demo-rn.webp" style={{ width: '100%', cursor: 'pointer' }} onClick={() => setOpen9(true)} className="w3-hover-opacity" alt="Clone de Flappy Bird" />
          ...
          <Modal open={open9} onClose={() => setOpen9(false)} center>
            <a href="https://snack.expo.io/@rodolphe37/a6897e" target="new">
              ...
              <img className="img-cursor" src="/assets/images/developpeur/demo.rn.gif" style={{ width: '100%' }} onClick={() => setOpen9(true)} className="w3-hover-opacity" alt="Clone de Flappy Bird" />
            </a>
          </Modal>
        </div>
      </div>
      <div className="w3-col l3 m6">
        <div className="tooltip-dev" data-tooltip="Theme Artiste responsive - (React/React-router). &#xa; &#xa; Theme conçu avec React et React-router."
          data-tooltip-location="bottom">
          <img className="img-cursor" src="/assets/images/developpeur/demo.v2.webp" style={{ width: '100%', cursor: 'pointer' }} onClick={() => setOpen10(true)} className="w3-hover-opacity" alt="Theme Artiste responsive" />
          ...
          <Modal open={open10} onClose={() => setOpen10(false)} center>
            <a href="https://github.com/rodolphe37/magnetic-react-template" target="new">
              ...
              <img className="img-cursor" src="/assets/images/developpeur/demo.v2.gif" style={{ width: '100%' }} onClick={() => setOpen10(true)} className="w3-hover-opacity" alt="Theme Artiste responsive" />
            </a>
          </Modal>
        </div>
      </div>
      <div className="w3-col l3 m6">
        <div className="tooltip-dev" data-tooltip="Site Amano-Hilot - (Next/Strapi). &#xa; &#xa; Site conçu avec React, Next, Bootstrap et ReactStrap, Next-seo ainsi que Sass pour le frontend, pour le backend j'ai utilisé le CMS Strapi et une base de données MySQL."
          data-tooltip-location="bottom">
          <img className="img-cursor" src="/assets/images/developpeur/amano-hilot.webp" style={{ width: '100%', cursor: 'pointer' }} onClick={() => setOpen11(true)} className="w3-hover-opacity" alt="Site Amano-Hilot" />
          ...
          <Modal open={open11} onClose={() => setOpen11(false)} center>
            ...
            <img className="img-cursor" src="/assets/images/developpeur/amano-hilot.gif" style={{ width: '100%' }} onClick={() => setOpen11(true)} className="w3-hover-opacity" alt="Site Amano-Hilot" />
          </Modal>
        </div>
      </div>
      <div className="w3-col l3 m6">
        <div className="tooltip-dev" data-tooltip="Site Jeux Amano-hilot - (React-Spring/Express). &#xa; &#xa; Site conçu avec React, React-spring, Spectre.css, Node-sass, Styled Components et Typescript en frontend ainsi que express pour le backend."
          data-tooltip-location="bottom">
          <img className="img-cursor" src="/assets/images/developpeur/allGames.webp" style={{ width: '100%', cursor: 'pointer' }} onClick={() => setOpen12(true)} className="w3-hover-opacity" alt="Site Jeux Amano-hilot" />
          ...
          <Modal open={open12} onClose={() => setOpen12(false)} center>
            <a>
              ...
              <img className="img-cursor" src="/assets/images/developpeur/allGames.gif" style={{ width: '100%' }} onClick={() => setOpen12(true)} className="w3-hover-opacity" alt="Site Jeux Amano-hilot" />
            </a>
          </Modal>
        </div>
      </div>
