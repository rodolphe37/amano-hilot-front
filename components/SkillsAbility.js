      ...
      <section className="skills-sec">
        <div className="container ability">
          ...
          <h5>
            ...
            j'ai découvert et apprécié travailler avec d'autres frameworks ou librairies comme Next pour les sites (SEO ready),  React-Native ou Flutter\Dart
            pour les versions mobiles ainsi que Electron pour les versions Desktop.
            <br />
            <br />
          ...
          <ul className="skills-set">
            <Fade left cascade ssrFadeout>
              ...
              <li className="indvidual-skill">
                <div className="skill_title">
                  <span><i class="fas fa-file-code"></i> Php - CMS (Drupal8, joomla, wordpress, prestashop)</span>
                </div>
                <div className="barfiller">
