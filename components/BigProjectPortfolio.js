    ...
    <div className="w3-container w3-light-grey" style={{ padding: '128px 16px' }}>
      <div className="w3-row-padding">
        <div className="w3-col m6">
          ...
          <h5>Vous l'avez sous les yeux... C'est le site sur lequel vous surfez.</h5>
        ...
        <div className="w3-col m6">
          <img className="w3-image w3-round-large img-medium-work" src="/assets/images/developpeur/amano-hilot.webp" alt="Buildings" width={700} height={394} />
        </div>
      </div>
    </div>
