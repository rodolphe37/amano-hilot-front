...
const MyWorksPortfolio = () => {
  ...
  return (
    <div className="w3-container" style={{ padding: '15px 16px' }} id="work">
      ...
      {onClicked === true ? (<img className="info-perso" src="/assets/images/presentation/perso-2.png" alt="développeur" />) : (<img className="info-perso" src="/assets/images/presentation/perso-2b.png" alt="développeur" />)}
