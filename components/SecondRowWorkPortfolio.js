    ...
    <div className="w3-row-padding w3-section">
      <div className="w3-col l3 m6">
        <div className="tooltip-dev" data-tooltip="Sort The Waste Game - (React/Electron). &#xa; &#xa; Le coeur du jeu est basé sur un timer conçu avec un CustomHook. Le jeu est conçu avec Electron, React (Hooks), React-beautiful-dnd, Spectre.css et Typescript. "
          ...
          <img className="img-cursor" src="/assets/images/developpeur/sortwaste.webp" style={{ width: '100%', cursor: 'pointer' }} onClick={() => setOpenc(true)} className="w3-hover-opacity" alt="Sort The Waste Game" />
          ...
          <Modal open={openc} onClose={() => setOpenc(false)} center>
            <a href="https://github.com/rodolphe37/install-games-repository/blob/master/README.md" target="new">
              ...
              <img className="img-cursor" src="/assets/images/developpeur/waste.gif" style={{ width: '100%' }} onClick={() => setOpenc(true)} className="w3-hover-opacity" alt="Sort The Waste Game" />
            </a>
          </Modal>
        </div>
      </div>
      <div className="w3-col l3 m6">
        <div className="tooltip-dev" data-tooltip="Asanas Guessing Game - (React/express/Electron). &#xa; &#xa; Le coeur du jeu est basé sur un timer conçu avec un CustomHook. Le jeu est conçu avec Electron et React (Hooks) seulement, sans aucunes autres dépendances pour le frontend et Express pour le backend. "
          data-tooltip-location="top">
          <img className="img-cursor" src="/assets/images/developpeur/asanas.webp" style={{ width: '100%', cursor: 'pointer' }} onClick={() => setOpenc1(true)} className="w3-hover-opacity" alt="Asanas Gessing Game" />
          ...
          <Modal open={openc1} onClose={() => setOpenc1(false)} center>
            <a href="https://github.com/rodolphe37/asanas-guess-game-free-version" target="new">
              ...
              <img className="img-cursor" src="/assets/images/developpeur/asanas.gif" style={{ width: '100%' }} onClick={() => setOpenc1(true)} className="w3-hover-opacity" alt="Asanas Gessing Game" />
            </a>
          </Modal>
        </div>
      </div>
      <div className="w3-col l3 m6">
        <div className="tooltip-dev" data-tooltip="The Wild Circus - (React/Express). &#xa; &#xa; Le frontend est conçu avec React (Hooks) et Redux, ainsi que Express et MySQL pour le backend"
          data-tooltip-location="top">
          <img className="img-cursor" src="/assets/images/developpeur/wildcircus.webp" style={{ width: '100%', cursor: 'pointer' }} onClick={() => setOpenc2(true)} className="w3-hover-opacity" alt="The Wild Circus" />
          ...
          <Modal open={openc2} onClose={() => setOpenc2(false)} center>
            <a href="https://github.com/rodolphe37/checkpoint4-circus" target="new">
              ...
              <img className="img-cursor" src="/assets/images/developpeur/wildcircus.gif" style={{ width: '100%' }} onClick={() => setOpenc2(true)} className="w3-hover-opacity" alt="The Wild Circus" />
            </a>
          </Modal>
        </div>
      </div>
      <div className="w3-col l3 m6">
        <div className="tooltip-dev" data-tooltip="Gestion d'utilisateurs NFC_Update - (React-admin/Express). &#xa; &#xa; Le site est conçu avec React, React-admin, chart.js, recompose, Redux, validator et Material UI Hooks pour le frontend. Pour le backend, bcryptjs, express, express-jwt, is-empty, jsonwebtoken, MySQl2, passport et sequelize comme ORM avec base de donnée MySQL"
          data-tooltip-location="top">
          <img className="img-cursor" src="/assets/images/developpeur/movieDemo.webp" style={{ width: '100%', cursor: 'pointer' }} onClick={() => setOpenc3(true)} className="w3-hover-opacity" alt="Gestion d'utilisateurs NFC_Update" />
          ...
          <Modal open={openc3} onClose={() => setOpenc3(false)} center>
            <a href="https://github.com/rodolphe37/nfc-updates-front" target="new">
              ...
              <img className="img-cursor" src="/assets/images/developpeur/movieDemo.gif" style={{ width: '100%' }} onClick={() => setOpenc3(true)} className="w3-hover-opacity" alt="Gestion d'utilisateurs NFC_Update" />
            </a>
          </Modal>
        </div>
      </div>
